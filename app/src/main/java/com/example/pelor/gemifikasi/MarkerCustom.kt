...
val kategoriMarkers: Map<String, KategoriData> = mapOf(
    "Sejarah" to KategoriData.MarkerList(
        listOf(
            MarkerItem(
    ...
    "Penginapan" to KategoriData.MarkerList(
        listOf(
            MarkerItem(
    ...
    "Restorant" to KategoriData.MarkerList(
        listOf(
            MarkerItem(
                title = "Penginapan Sulthan Pulau Penyengat",
                latitude = 0.9284278904364163,
    ...
    "Event & Agenda" to KategoriData.EventAgenda(
        EventAgendaData(
            zones = listOf(
                ZoneData(
                    points = listOf(
    ...
    "Kuliner" to KategoriData.EventAgenda(
        EventAgendaData(
            zones = listOf(
                ZoneData(
                    points = listOf(
